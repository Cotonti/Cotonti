...
<div class="col3-2">
    ...
    <ul class="icons">
        <li>
            <a href="page.php?m=add"><img src="themes/admin/spring/img/big_icons/page_add.png">{PHP.L.Submitnew}</a>
        </li>
        <li>
            <a href="admin.php?m=structure&n=page"><img src="themes/admin/spring/img/big_icons/table_edit.png">{PHP.L.adm_quick_categories}</a>
        </li>
    </ul>
</div>
