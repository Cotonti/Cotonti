		...
		<table class="cells">
			...
			<tr>
				...
				<td class="action {ADMIN_STRUCTURE_ODDEVEN}">
					<!-- IF {ADMIN_STRUCTURE_CONFIG_URL} --><a href="{ADMIN_STRUCTURE_CONFIG_URL}" class="button"><span class="pen icon"></span>{PHP.L.short_config}</a><!-- ENDIF -->
					<!-- IF {ADMIN_STRUCTURE_RIGHTS_URL} --><a href="{ADMIN_STRUCTURE_RIGHTS_URL}" class="button"><span class="unlock icon"></span>{PHP.L.short_rights}</a><!-- ENDIF -->
					<!-- IF {ADMIN_STRUCTURE_OPTIONS_URL} --><a href="{ADMIN_STRUCTURE_OPTIONS_URL}" class="ajax button"><span class="cog icon"></span>{PHP.L.short_options}</a><!-- ENDIF -->
					<!-- IF {PHP.dozvil} --><a href="{ADMIN_STRUCTURE_UPDATE_DEL_URL}" class="confirmLink negative button"><span class="cross icon"></span>{PHP.L.short_delete}</a><!-- ENDIF -->
					<!-- IF {ADMIN_STRUCTURE_JUMPTO_URL} --><a href="{ADMIN_STRUCTURE_JUMPTO_URL}" class="button special positive"><span class="book icon"></span>{PHP.L.short_open}</a><!-- ENDIF -->
				</td>
			</tr>
			<!-- END: ROW -->
			<tr>
