<!-- BEGIN: MAIN -->
			...
			<div id="left" class="whitee">
				...
				<p class="breadcrumb">{PHP.themelang.list.bread}: <a href="users.php">{PHP.L.Users}</a> {PHP.cfg.separator} <a href="users.php?m=details&amp;id={PHP.usr.id}&amp;u={PHP.usr.name}">{USERS_PROFILE_NAME}</a> {PHP.cfg.separator} <a href="users.php?m=profile">{PHP.L.Profile} {PHP.L.Update}</a></p>
				...
				<fieldset>
					...
					<div><label>{PHP.themelang.usersprofile.current} {PHP.L.Password}</label>{USERS_PROFILE_OLDPASS}</div>
					<div><label>{PHP.themelang.usersprofile.Newpassword}</label>{USERS_PROFILE_NEWPASS1} {USERS_PROFILE_NEWPASS2}</div>
	...
	<div id="right">
		...
		<div class="padding15 admin" style="padding-bottom:0">
			<ul>
				<li><a href="users.php?m=profile#privacy">{PHP.themelang.usersprofile.privacy}</a></li>
				<li><a href="users.php?m=profile#settings">{PHP.themelang.usersprofile.settings}</a></li>
				<li><a href="users.php?m=profile#personal">{PHP.themelang.usersprofile.personal}</a></li>
				<li><a href="users.php?m=profile#contact">{PHP.themelang.usersprofile.contact}</a></li>
