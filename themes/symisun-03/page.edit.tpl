<!-- BEGIN: MAIN -->
			...
			<div id="left" class="whitee" style="margin-right:23px;">
				...
				<div id="right" style="margin:0 0 0 18px;">
					...
					<h3>{PHP.themelang.pageadd.adv}</h3>
					<div class="box padding15">
					...
					<h3>{PHP.themelang.pageadd.dates}</h3>
					...
					<div class="box padding15">
						<!-- IF !{PHP.usr.isadmin} -->
						<p class="red">{PHP.themelang.pageadd.Formhint}</p>
						<!-- ENDIF -->
					...
					<h3>{PHP.themelang.pageedit.del}</h3>
					<div class="box padding15">
						<p><strong class="red">{PHP.themelang.pageedit.Deletethispage}</strong> &nbsp; {PAGEEDIT_FORM_DELETE}</p>
					</div>
				...
				<fieldset>
					...
					<span class="hint">{PHP.themelang.pageedit.Pageid}: #{PAGEEDIT_FORM_ID}</span></div>
				...
				<fieldset>
					...
					<div><label>{PHP.themelang.pageadd.File}</label>{PAGEEDIT_FORM_FILE} &nbsp; 
					<span class="hint">{PHP.themelang.pageadd.Filehint}</span></div>
					<div><label>{PHP.L.URL}</label>{PAGEEDIT_FORM_URL} &nbsp; 
					{PAGEEDIT_FORM_PFS_URL_USER} &nbsp; {PAGEEDIT_FORM_PFS_URL_SITE} &nbsp; 
					<span class="hint">{PHP.themelang.pageadd.URLhint}</span></div>
					<div><label>{PHP.themelang.pageadd.Filesize}</label>{PAGEEDIT_FORM_SIZE} &nbsp; 
					<span class="hint">{PHP.themelang.pageadd.Filesizehint}</span></div>
					<div><label>{PHP.themelang.pageedit.Filehitcount}</label>{PAGEEDIT_FORM_FILECOUNT} &nbsp; 
					<span class="hint">{PHP.themelang.pageedit.Filehitcounthint}</span></div>
				</fieldset>
