<!-- BEGIN: MAIN -->
			...
			<div id="left" class="whitee" style="margin-right:23px;">
				...
				<div>
					<label>{PHP.themelang.pageadd.File}</label>
					{PAGEADD_FORM_FILE} &nbsp; <span class="hint">{PHP.themelang.pageadd.Filehint}</span>
				</div>
				<div>
					<label>{PHP.L.URL}</label>
					{PAGEADD_FORM_URL} &nbsp; {PAGEADD_FORM_PFS_URL_USER} &nbsp; {PAGEADD_FORM_PFS_URL_SITE} &nbsp; <span class="hint">{PHP.themelang.pageadd.URLhint}</span>
				</div>
				<div>
					<label>{PHP.themelang.pageadd.Filesize}</label>
					{PAGEADD_FORM_SIZE} &nbsp; <span class="hint">{PHP.themelang.pageadd.Filesizehint}</span>
				</div>
				</fieldset>
