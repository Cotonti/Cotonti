<!-- BEGIN: MAIN -->
			...
			<div id="left">
				...
				<!-- you are here -->
				<p class="breadcrumb">{PHP.themelang.list.bread}: {USERS_DETAILS_TITLE}</p>

				<!-- IF {USERS_DETAILS_PHOTO} -->
				{USERS_DETAILS_PHOTO}
				<!-- ELSE -->
				<img src="themes/{PHP.theme}/img/nophoto.jpg" width="150" height="150" alt="{PHP.L.Photo}" class="photo" />
				<!-- ENDIF -->
