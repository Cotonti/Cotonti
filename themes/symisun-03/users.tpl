<!-- BEGIN: MAIN -->
			...
			<div id="left" class="whitee">
				...
				<p class="breadcrumb">{PHP.themelang.list.bread}: <a href="users.php">{PHP.L.Users}</a></p>&nbsp;
	...
	<div id="right">
		...
		<!-- ELSE -->
		<h3><a href="users.php?m=auth">{PHP.themelang.users.login}</a></h3>
		<!-- ENDIF -->
