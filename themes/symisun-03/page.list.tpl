...
<div id="content">
  <div class="padding20">
    ...
    <!-- IF {LIST_TOP_TOTALLINES} != 0 -->
		...
		<a href="index.php?e=page&c={PHP.c}&amp;s=title&amp;w=desc&amp;o={PHP.o}&amp;p={PHP.p}"><img src="themes/{PHP.theme}/img/system/arrow-up.gif" alt="" /></a>
		<a href="index.php?e=page&c={PHP.c}&amp;s=title&amp;w=asc&amp;o={PHP.o}&amp;p={PHP.p}"><img src="themes/{PHP.theme}/img/system/arrow-down.gif" alt="" /></a>
		| <strong>{PHP.L.Views}</strong>
		<a href="index.php?e=page&c={PHP.c}&amp;s=count&amp;w=desc&amp;o={PHP.o}&amp;p={PHP.p}"><img src="themes/{PHP.theme}/img/system/arrow-up.gif" alt="" /></a>
		<a href="index.php?e=page&c={PHP.c}&amp;s=count&amp;w=asc&amp;o={PHP.o}&amp;p={PHP.p}"><img src="themes/{PHP.theme}/img/system/arrow-down.gif" alt="" /></a>
		| <strong>{PHP.L.Date}</strong>
		<a href="index.php?e=page&c={PHP.c}&amp;s=date&amp;w=desc&amp;o={PHP.o}&amp;p={PHP.p}"><img src="themes/{PHP.theme}/img/system/arrow-up.gif" alt="" /></a>
		<a href="index.php?e=page&c={PHP.c}&amp;s=date&amp;w=asc&amp;o={PHP.o}&amp;p={PHP.p}"><img src="themes/{PHP.theme}/img/system/arrow-down.gif" alt="" /></a> </p>
		<!-- ELSE -->
