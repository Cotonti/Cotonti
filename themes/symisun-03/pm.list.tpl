    ...
    <div id="content">
        <div class="padding20">
            <div id="left">
                ...
                <div class="breadcrumb">{PHP.themelang.list.bread}: <a href="{PHP|cot_url('users')}">{PHP.L.Users}</a>
                ...
                <form action="{PM_FORM_UPDATE}" method="post" name="update" id="update" class="ajax">
                    <table class="cells">
                        <tr>
                            <td class="coltop width5">
								...
								<input class="checkbox" type="checkbox"
									   value="{PHP.themelang.pm.Selectall}/{PHP.themelang.pm.Unselectall}"
                                       onclick="$('.checkbox').attr('checked', this.checked);" />
                                <!-- ENDIF -->
                            </td>
                        ...
                        <!-- BEGIN: PM_ROW -->
                        <tr>
                            <td class="centerall {PM_ROW_ODDEVEN}">
								<input type="checkbox" class="checkbox" name="msg[{PM_ROW_ID}]"/>
							</td>
