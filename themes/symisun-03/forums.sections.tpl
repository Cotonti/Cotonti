<!-- BEGIN: MAIN -->
	...
	<div id="right">
		...
		<div class="box padding15 admin centerimg"> 
			<img src="images/admin/ipsearch.png" alt="{PHP.L.Search}" /> <a href="plug.php?e=search&amp;frm=1">{PHP.themelang.forumssections.Searchinforums}</a><br />
			<img src="images/admin/statistics.png" alt="{PHP.L.Statistics}" /> <a href="plug.php?e=forumstats">{PHP.L.Statistics}</a><br />
			<img src="images/admin/reset.png" alt="{PHP.L.Reset}" /> <a href="forums.php?n=markall">{PHP.themelang.forumssections.Markasread}</a><br />
		</div>
