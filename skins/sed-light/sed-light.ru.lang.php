...
$skinlang['usersprofile']['Emailnotes'] = 'Чтобы изменить email: (если смена email доступна) <ol>
											<li>Вам придется реактивировать аккаунт по электронной почте, чтобы доказать достоверность email адреса.</li>
											<li>Пока вы не воспользуетесь ссылкой валидации, ваш старый email будет функционировать.</li>
											<li>После нажатия на ссылку, ваш e-mail адрес изменится.</li>
											</ol>'; // N-0.1.0
