...
$skinlang['pageadd']['Formhint'] = 'Проверьте правильность внесения всех полей, вы не сможете исправить их позже.<br />Если вам все же необходимо что-либо исправить, <a href="'.sed_url('plug', 'e=contactus').'">свяжитесь с нами</a>.<br />Страница станет общедоступной, только после того как администрация ее проверит и утвердит.<br />';
