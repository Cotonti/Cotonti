...
<!-- END: LOG_ROW -->
<tr><td colspan="6"><div class="pagnav">{ADMIN_LOG_PAGINATION_PREV} {ADMIN_LOG_PAGNAV} {ADMIN_LOG_PAGINATION_NEXT}</div></td></tr>
<tr><td colspan="6">{PHP.L.Total} : {ADMIN_LOG_TOTALITEMS}, {PHP.L.adm_polls_on_page} : {ADMIN_LOG_ON_PAGE}</td></tr>
</table>
<!-- END: LOG -->