...
<!-- END: RATINGS_ROW -->
<tr>
	<td colspan="6"><div class="pagnav">{ADMIN_RATINGS_PAGINATION_PREV} {ADMIN_RATINGS_PAGNAV} {ADMIN_RATINGS_PAGINATION_NEXT}</div></td>
</tr>
<tr>
	<td colspan="6">{PHP.L.adm_ratings_totalitems} : {ADMIN_RATINGS_TOTALITEMS}, {PHP.L.adm_polls_on_page}: {ADMIN_RATINGS_ON_PAGE}</td>
</tr>
<tr>
