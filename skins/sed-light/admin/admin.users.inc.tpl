...
<!-- BEGIN: USERS_ROW -->
		<tr>
			<td><img src="images/admin/groups.gif" alt="" /><a href="{ADMIN_USERS_ROW_GRP_TITLE_URL}">{ADMIN_USERS_ROW_GRP_TITLE}</a></td>
...
<!-- END: USERS_ROW -->
		...
		<form id="addlevel" action="{ADMIN_USERS_FORM_URL}" method="post">
			<table class="cells">
			<tr>
				<td>{PHP.L.Group} :</td>
...
<!-- BEGIN: ADMIN_USERS_EDIT -->
		<form id="editlevel" action="{ADMIN_USERS_EDITFORM_URL}" method="post">
			<table class="cells">
			<tr>
				<td>{PHP.L.Group} :</td>
...
<!-- ENDIF -->
			...
			<tr>
				<td>{PHP.L.Rights} :</td>
				<td><a href="{ADMIN_USERS_EDITFORM_RIGHT_URL}"><img src="images/admin/rights.gif" alt="" /></a>
			</tr>
<!-- IF {PHP.g} > 5 -->
			<tr>
				<td>{PHP.L.Delete} :</td>
				<td>[<a href="{ADMIN_USERS_EDITFORM_DEL_URL}">x</a>]</td>
			</tr>
<!-- ENDIF -->
			<tr>
