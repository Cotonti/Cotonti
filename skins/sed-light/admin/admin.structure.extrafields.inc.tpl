<!-- BEGIN: STRUCTURE_EXTRAFIELDS -->
		<div id="{ADMIN_STRUCTURE_EXTRAFIELDS_AJAX_OPENDIVID}">
<!-- IF {PHP.is_adminwarnings} -->
			<div class="error">{ADMIN_STRUCTURE_EXTRAFIELDS_ADMINWARNINGS}</div>
<!-- ENDIF -->
			<table class="cells">
			<tr>
...
<!-- END: STRUCTURE_EXTRAFIELDS_ROW -->
			...
			<tr>
				<td>
					<div class="pagnav">{ADMIN_STRUCTURE_EXTRAFIELDS_PAGINATION_PREV} {ADMIN_STRUCTURE_EXTRAFIELDS_PAGNAV} {ADMIN_STRUCTURE_EXTRAFIELDS_PAGINATION_NEXT}</div>
				</td>
			</tr>
			<tr>
				<td>{PHP.L.Total} : {ADMIN_STRUCTURE_EXTRAFIELDS_TOTALITEMS}, {PHP.L.adm_polls_on_page}: {ADMIN_STRUCTURE_EXTRAFIELDS_COUNTER_ROW}</td>
			</tr>
			</table>
