...
<!-- ENDIF -->
			...
			<form id="form_valqueue" name="form_valqueue" method="post" action="{ADMIN_PAGE_FORM_URL}">
				<table class="cells" width='100%' style="width:100%;">
				<tr>
					<td style="width:15px;" class="coltop">
<!-- IF {PHP.cfg.jquery} -->
						<input name="allchek" class="checkbox" type="checkbox" value="" onclick="$('.checkbox').attr('checked', this.checked);" />
<!-- ENDIF -->
					</td>
					<td style="width:35px;" class="coltop">#</td>
					<td class="coltop">{PHP.L.Title}</td>
					<td style="width:60px;" class="coltop" colspan="3">{PHP.L.Edit}<br />{PHP.L.Validate}<br />{PHP.L.Delete}</td>
				</tr>
<!-- BEGIN: PAGE_ROW -->
				<tr>
					<td style="text-align:center;vertical-align:top;" class="{ADMIN_PAGE_ODDEVEN}"><input name="s[{ADMIN_PAGE_ID}]" type="checkbox" class="checkbox" /></td>
					<td style="text-align:center;vertical-align:top;" class="{ADMIN_PAGE_ODDEVEN}"><a href="{ADMIN_PAGE_ID_URL}">{ADMIN_PAGE_ID}</a></td>
					<td style="text-align:left;" class="{ADMIN_PAGE_ODDEVEN}">
					...
					<td style="text-align:center;vertical-align:top;width:20px;" class="{ADMIN_PAGE_ODDEVEN}"><a title="{PHP.L.Edit}" href="{ADMIN_PAGE_URL_FOR_EDIT}">{PHP.R.admin_icon_manual}</a></td>
					<td style="text-align:center;vertical-align:top;width:20px;" class="{ADMIN_PAGE_ODDEVEN}"><a title="{PHP.L.Validate}" href="{ADMIN_PAGE_URL_FOR_VALIDATED}"{ADMIN_PAGE_URL_FOR_VALIDATED_AJAX}>{PHP.R.admin_icon_jumpto}</a></td>
					<td style="text-align:center;vertical-align:top;width:20px;" class="{ADMIN_PAGE_ODDEVEN}"><a title="{PHP.L.Delete}" href="{ADMIN_PAGE_URL_FOR_DELETED}"{ADMIN_PAGE_URL_FOR_DELETED_AJAX}>{PHP.R.admin_icon_delete}</a></td>
				</tr>
<!-- END: PAGE_ROW -->
<!-- IF {PHP.is_row_empty} -->
				<tr>
