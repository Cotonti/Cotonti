<!-- BEGIN: MAIN -->
	...
	<div class="mboxHD">{USERS_DETAILS_TITLE}</div>
	<div class="mboxBody">

		<!-- BEGIN: USERS_DETAILS_ADMIN -->
		<div id="subtitle">{USERS_DETAILS_ADMIN_EDIT}</div>
		...
		<table class="cells" border="0" cellspacing="1" cellpadding="2">
			...
			<tr>
				<td>{PHP.skinlang.usersdetails.IRC}</td>
				<td>{USERS_DETAILS_IRC}</td>
			</tr>
			<tr>
				<td>{PHP.skinlang.usersdetails.ICQ}</td>
