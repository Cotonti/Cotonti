<!-- BEGIN: MAIN -->
    ...
    <div id="content">
    	<div class="padding20 whitee">
        	<div id="left">
        	<h1>{PHP.L.Users}</h1>
            <div class="breadcrumb">{PHP.skinlang.list.bread}: <a href="users.php">{PHP.L.Users}</a></div>
            &nbsp;
            <div class="nou">
			{USERS_TOP_FILTERS_COUNTRY} {USERS_TOP_FILTERS_MAINGROUP} {USERS_TOP_FILTERS_GROUP}
            <div class="admin ssrh">{USERS_TOP_FILTERS_SEARCH}</div>
            </div>
            &nbsp;
            <!-- IF {USERS_TOP_TOTALUSERS} > 0 -->
			<p style="border-bottom:1px solid #ececec">{PHP.skinlang.list.sort}<br />
