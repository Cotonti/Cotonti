<!-- BEGIN: MAIN -->
			...
			<div id="left">
				...
				<!-- you are here -->
				<p class="breadcrumb">{PHP.skinlang.list.bread}: <a href="index.php">{PHP.L.Home}</a> {PHP.cfg.separator} <a href="plug.php?e=statistics">{PHP.L.plu_title}</a></p>
				...
				<div class="pagetext nou">
					<div style="width:50%" class="fleft admin secrow"><a href="{STATISTICS_PLU_URL}#members"><strong class="even">{PHP.L.Country}</strong> {PHP.sed_img_down}</a></div>
					<div style="width:50%" class="fright admin secrow"><a href="{STATISTICS_SORT_BY_USERCOUNT}#members"><strong class="even">{PHP.L.Users}</strong> {PHP.sed_img_down}</a></div>
					<div class="clear">&nbsp;</div>
					<!-- BEGIN: ROW_COUNTRY -->
