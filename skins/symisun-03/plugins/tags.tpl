<!-- BEGIN: MAIN -->
			...
			<div id="left" class="whitee">
				...
				<!-- you are here -->
				<p class="breadcrumb">{PHP.skinlang.list.bread}: <a href="index.php">{PHP.L.Home}</a> {PHP.cfg.separator} <a href="plug.php?e=tags">{PHP.L.Tags}</a><!-- IF {TAGS_QUERY} --> {PHP.cfg.separator} {TAGS_QUERY}<!-- ENDIF --></p>
