...
<p class="centerall" style="margin-top:10px"><strong>{POLL_VOTERS} {PHP.skinlang.ratings.Votes}</strong> {PHP.L.polls_since} {POLL_SINCE_SHORT}</p>
<!-- END: POLL_VIEW_VOTED -->
...
<p>&nbsp;<br />&nbsp;</p>
<span class="comb">
<a href="polls.php?id={IPOLLS_ID}#com" class="commv"><span>{PHP.skinlang.comments.comments}</span></a>
</span>
<!-- END: POLL -->
<!-- END: INDEXPOLLS -->