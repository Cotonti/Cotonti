<!-- BEGIN: MAIN -->
			...
			<div id="left">
				...
				<p class="right"> {PHP.skinlang.list.sort} &nbsp; 
				<strong>{LIST_TOP_DATE} &nbsp; {LIST_TOP_TITLE} &nbsp; {LIST_TOP_COUNT}</strong>
				</p>
				<!-- ELSE -->
				<div class="red mt15">{PHP.skinlang.list.none}</div>
				<!-- ENDIF -->
	...
	<div id="right">
		...
		<div class="box padding15"> 
			...
			{PHP.skinlang.list.linesinthissection}: <strong>{LIST_TOP_TOTALLINES}</strong> 
		</div>
		<!-- ENDIF -->
