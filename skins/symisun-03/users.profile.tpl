...
<div id="content">
  <div class="padding20 whitee">
    <div id="left">
      ...
      <div class="breadcrumb">{PHP.skinlang.list.bread}: <a href="users.php">{PHP.L.Users}</a> <a href="users.php?m=details&amp;id={PHP.usr.id}&amp;u={PHP.usr.name}">{USERS_PROFILE_NAME}</a> <a href="users.php?m=profile">{PHP.L.Profile} {PHP.L.Update}</a> </div>
...
//]]>
          ...
          <div>
            ...
            {USERS_PROFILE_EMAILPASS} &nbsp; <span class="hint">{PHP.skinlang.usersprofile.Emailnotes}</span> </div>
          <!-- END: USERS_PROFILE_EMAILPROTECTION -->
          <!-- END: USERS_PROFILE_EMAILCHANGE -->
          <div>
            <label>{PHP.L.Hide} {PHP.L.Email}</label>
            {USERS_PROFILE_HIDEEMAIL} &nbsp; <span class="hint">{PHP.skinlang.usersprofile.Hidetheemail}</span> </div>
          <div>
            <label>{PHP.skinlang.usersprofile.PMnotify}</label>
            {USERS_PROFILE_PMNOTIFY} &nbsp; <span class="hint">{PHP.skinlang.usersprofile.PMnotifyhint}</span> </div>
        </fieldset>
        <a id="settings" name="settings"></a>
        <fieldset>
          <legend>{PHP.skinlang.usersprofile.settings}</legend>
          <div>
            <label>{PHP.L.Skin}</label>
            {USERS_PROFILE_SKIN}{USERS_PROFILE_THEME} </div>
          <div>
            <label>{PHP.L.Language}</label>
            {USERS_PROFILE_LANG} </div>
        </fieldset>
        ...
        <fieldset>
          ...
          <div>
            ...
            {USERS_PROFILE_COUNTRY} </div>
          <div>
            <label>{PHP.L.Location}</label>
            {USERS_PROFILE_LOCATION} </div>
          <div>
            <label>{PHP.L.Timezone}</label>
            {USERS_PROFILE_TIMEZONE} </div>
          <div>
            <label>{PHP.L.Birthdate}</label>
            {USERS_PROFILE_BIRTHDATE} </div>
          <div>
            <label>{PHP.L.Occupation}</label>
            {USERS_PROFILE_OCCUPATION} </div>
          <div>
            <label>{PHP.L.Gender}</label>
            {USERS_PROFILE_GENDER} </div>
        </fieldset>
        <a id="contact" name="contact"></a>
        <fieldset>
          <legend>{PHP.skinlang.usersprofile.contact}</legend>
          <div>
            <label>{PHP.L.Website}</label>
            {USERS_PROFILE_WEBSITE} </div>
          <div>
            <label>{PHP.L.MSN}</label>
            {USERS_PROFILE_MSN} </div>
          <div>
            <label>{PHP.L.ICQ}</label>
            {USERS_PROFILE_ICQ} </div>
        </fieldset>
        ...
        <fieldset>
          ...
          <div>
            ...
            {USERS_PROFILE_AVATAR} </div>
          <div>
            <label>{PHP.L.Photo}</label>
            {USERS_PROFILE_PHOTO} </div>
        </fieldset>
        <a id="sig" name="sig"></a>
        <fieldset>
          ...
          <div style="padding:0 10px; margin-top:-15px">
            ...
            <span class="hint padding15">{PHP.cfg.usertextmax} {PHP.skinlang.usersprofile.characters}</span> </div>
        </fieldset>
        ...
        <fieldset>
          ...
          <div>
            <label>{PHP.skinlang.usersprofile.current} {PHP.L.Password}</label>
            {USERS_PROFILE_OLDPASS} </div>
          <div>
            <label>{PHP.skinlang.usersprofile.Newpassword}</label>
            {USERS_PROFILE_NEWPASS1} {USERS_PROFILE_NEWPASS2} </div>
