		...
		<div id="side" class="column">
			...
			<div class="block">
				...
				<ul class="follow">
					...
					<li><a href="admin.php?m=page&amp;s=structure">{PHP.L.home_ql_b2_1}</a></li>
					<li><a href="admin.php?m=page&amp;s=extrafields">{PHP.L.home_ql_b2_2}</a></li>
					<li><a href="admin.php?m=structure&amp;s=extrafields">{PHP.L.home_ql_b2_3}</a></li>
			...
			<div class="block">
				...
				<ul class="follow">
					...
					<li><a href="admin.php?m=users&amp;s=extrafields">{PHP.L.home_ql_b3_2}</a></li>
