...
<!-- END: PAG_EXTRAFIELDS_ROW -->
			...
			<tr>
				<td>
					<div class="pagnav">{ADMIN_PAG_EXTRAFIELDS_PAGINATION_PREV} {ADMIN_PAG_EXTRAFIELDS_PAGNAV} {ADMIN_PAG_EXTRAFIELDS_PAGINATION_NEXT}</div>
				</td>
			</tr>
			<tr>
				<td>{PHP.L.Total} : {ADMIN_PAG_EXTRAFIELDS_TOTALITEMS}, {PHP.L.adm_polls_on_page}: {ADMIN_PAG_EXTRAFIELDS_COUNTER_ROW}</td>
			</tr>
			</table>
