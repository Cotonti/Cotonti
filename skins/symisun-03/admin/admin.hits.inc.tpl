...
<!-- BEGIN: ROW -->
		<tr>
			<td style="width:128px; text-align:center; padding:1px;">{ADMIN_HITS_ROW_DAY}</td>
			<td style="text-align:right; width:96px; padding:1px;">{ADMIN_HITS_ROW_HITS} {PHP.L.Hits}</td>
			<td style="text-align:right; width:40px; padding:1px;">{ADMIN_HITS_ROW_PERCENTBAR}%</td>
			<td>
...
<!-- BEGIN: ROW_YEAR -->
		<tr>
			<td style="width:80px;text-align:center; padding:1px;"><a href="{ADMIN_HITS_ROW_YEAR_URL}">{ADMIN_HITS_ROW_YEAR}</a></td>
			<td style="text-align:right; width:96px; padding:1px;">{ADMIN_HITS_ROW_YEAR_HITS} {PHP.L.Hits}</td>
			<td style="text-align:right; width:40px; padding:1px;">{ADMIN_HITS_ROW_YEAR_PERCENTBAR}%</td>
			<td>
...
<!-- BEGIN: ROW_MONTH -->
		<tr>
			<td style="width:80px; text-align:center; padding:1px;"><a href="{ADMIN_HITS_ROW_MONTH_URL}">{ADMIN_HITS_ROW_MONTH}</a></td>
...
<!-- BEGIN: ROW_WEEK -->
		<tr>
			<td style="width:80px; text-align:center; padding:1px;">{ADMIN_HITS_ROW_WEEK}</td>
