<!-- BEGIN: MAIN -->
			...
			<div id="left" style="margin-right:25px" class="whitee">
				...
				<div class="maintenance"> {PHP.skinlang.usersauth.Maintenance}
					<p><strong>{PHP.skinlang.usersauth.Maintenancereason}:</strong> {USERS_AUTH_MAINTENANCERES}</p>
				</div>
				...
				<!-- ELSE -->
				<!-- you are here -->
				<p class="breadcrumb">{PHP.skinlang.list.bread}: <a href="users.php">{PHP.L.Users}</a> {PHP.cfg.separator} <a href="users.php?m=auth">{PHP.L.Login}</a></p>
				...
				<fieldset style="border:none">
					...
					<div class="remember"><label>&nbsp;</label>{PHP.skinlang.usersauth.Rememberme} {PHP.out.guest_cookiettl}</div>
	...
	<div id="right">
		...
		<h3><a href="plug.php?e=passrecover">{PHP.skinlang.usersauth.Lostpassword}</a></h3>
