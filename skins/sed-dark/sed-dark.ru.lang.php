...
[BEGIN_SED]
File=skins/sed-dark/sed-dark.ru.lang.php
Version=125
Updated=2007-mar-17
Type=Skin
Name=sed-dark
...
$skinlang['pageadd']['Formhint'] = "Проверьте правильность внесения всех полей, вы не сможете исправить их позже.<br />Если вам все же необходимо что-либо исправить, <a href=\"plug.php?e=contactus\">свяжитесь с нами</a>.<br />Страница станет общедоступной, только после того как администрация ее проверит и утвердит.<br />";
