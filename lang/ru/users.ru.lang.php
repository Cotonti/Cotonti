...
$L['pasrec_email1'] = 'Используйте указанную ниже ссылку для смены пароля:';
$L['pasrec_email1b'] = 'Внимание: если вы не обращались за сменой пароля, сообщаем вам, что запрос был сделан %2$s с IP-адреса %1$s.';
