...
$L['users_loggedinas'] = 'Вы авторизованы как';
$L['users_logoutfirst'] = 'Чтобы войти в другой аккаунт, вам нужно сначала выйти из учетной записи.';
...
$L['pro_invalidbirthdate'] = 'Неправильная дата рождения';
