 ...
 */
$Ls['Entries'] = "запись,записи,записей";
$Ls['Folders'] = "каталог,каталога,каталогов";
$Ls['Files'] = "файл,файла,файлов";
$Ls['Items'] = "элемент,элемента,элементов";

$Ls['Accounts'] = 'учетная запись,учетные записи,учетных записей';
...
$L['hookFileNotFound'] = '<strong>{$title}</strong>, событие - {$hook}: файл {$fileName} не найден. Пожалуйста, <a href="{$url}">обновите расширение</a>';
