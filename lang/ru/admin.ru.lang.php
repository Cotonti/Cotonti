 ...
 * Home Section
 */
$L['home_remove_install'] = 'Пожалуйста, удалите install.php до следующего обновления или защитите config.php от записи';
...
$L['home_update_revision'] = 'Текущая версия: <b>%1$s</b><br />Новая версия: <b>%2$s</b>';
...
$L['cfg_forcedefaultlang_hint'] = 'Переопределяет настройки в профиле пользователя';
...
$L['cfg_adminemail_hint'] = 'Необходимо для безопасности сайта';
$L['cfg_clustermode'] = 'Кластер серверов';
$L['cfg_clustermode_hint'] = 'Включать если используется кластерная система балансировки нагрузок';
...
$L['cfg_hostip_hint'] = 'IP-адрес сервера, опционально';
 ...
 */
$L['cfg_gzip'] = 'Gzip';
$L['cfg_gzip_hint'] = 'Gzip-сжатие для выходного HTML-кода. Не включайте эту опцию, если ваш сервер уже применяет Gzip к страницам сайта. Для проверки состояния Gzip-сжатия на вашем сайте используйте <a target="_blank" href="http://www.whatsmyip.org/http-compression-test/">HTTP Compression Test</a>';
...
$L['cfg_logWrongInput'] = 'Протоколировать ошибочный ввод';
$L['cfg_logWrongInput_hint'] = 'При отключении уменьшает объем протокола, но прекращает фиксировать неправильный ввод данных';
...
$L['cfg_devmode_hint'] = 'Отключить на действующем сайте';
$L['cfg_maintenance'] = 'Режим обслуживания';
$L['cfg_maintenance_hint'] = 'Доступ к сайту разрешен только для авторизованных групп';
$L['cfg_maintenancereason'] = 'Причина режима обслуживания';
$L['cfg_maintenancereason_hint'] = 'Коротко опишите, почему сайт находится в режиме обслуживания, опционально';
...
$L['cfg_redirbkonlogin_hint'] = 'Вернуться на страницу, открытую перед авторизацией';
$L['cfg_redirbkonlogout'] = 'Возврат после выхода';
$L['cfg_redirbkonlogout_hint'] = 'Вернуться на страницу, открытую перед выходом';
...
$L['cfg_disablesysinfos_hint'] = 'Тег используется в шаблоне footer.tpl';
$L['cfg_forcedefaulttheme'] = 'Принудительная установка темы по умолчанию для всех пользователей';
$L['cfg_forcedefaulttheme_hint'] = 'Переопределяет настройки в профиле пользователя';
$L['cfg_homebreadcrumb'] = 'Ссылка на главную страницу в навигационной цепочке';
$L['cfg_homebreadcrumb_hint'] = 'Принудительно добавить ссылку на главную страницу в начале навигационной цепочки';
$L['cfg_keepcrbottom'] = 'Добавить копирайт в тэг {FOOTER_BOTTOMLINE}';
$L['cfg_keepcrbottom_hint'] = 'Используется в шаблоне footer.tpl';
$L['cfg_msg_separate'] = 'Показывать сообщения отдельно для каждого источника';
$L['cfg_msg_separate_hint'] = '';
$L['cfg_separator'] = 'Разделитель';
$L['cfg_separator_hint'] = 'Используется в навигационной цепочке и проч.';
$L['cfg_showsqlstats'] = 'Показывать статистику SQL-запросов';
$L['cfg_showsqlstats_hint'] = 'Используется в шаблоне footer.tpl';
...
$L['ext_cat_customization'] = 'Тонкая настройка';
...
$L['ext_cat_i18n'] = 'Локализация контента';
...
$L['adm_structure_defaults'] = 'Настройки по умолчанию для структуры';
...
$L['adm_tpl_code'] = 'Код категории или шаблона';
...
$L['adm_extrafields_help_regex'] = 'Регулярное выражение для ввода значений';
...
$L['adm_group_has_no_rights'] = 'Группа не имеет прав';
$L['adm_groups_name_empty'] = 'Название группы не должно быть пустым';
$L['adm_groups_title_empty'] = 'Название участника группы не должно быть пустым';
