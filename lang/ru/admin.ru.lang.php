...
$L['cfg_parser_cache'] = array('Включить HTML-кэш', ' '); // New in 0.0.1
$L['cfg_parser_custom'] = array('Включить собственный парсер', ' '); // New in 0.0.1
$L['cfg_parser_disable'] = array('Отключить стандартный парсер', ' '); // New in 0.0.3
...
$L['cfg_cache_forums'] = array('Страничный кеш в форумах', 'Кеширует странички целиком для гостей'); // New in 0.7.0
$L['cfg_cache_index'] = array('Страничный кеш на главной', 'Главная страница будет статичной для всех гостей'); // New in 0.7.0
$L['cfg_cache_page'] = array('Страничный кеш в page и list', 'Кеширует странички целиком для гостей'); // New in 0.7.0
...
$L['cfg_hit_percision'] = array('Точность оптимизированного счётчика просмотров', ''); // New in 0.7.0
...
$L['cfg_pfsfilecheck'] = array('Проверка файлов', 'Проверять загружаемые файлы (&laquo;'.$L['PFS'].'&raquo; и профиль) на соответствие их формата используемому расширению. Рекомендуется включить в целях безопасности.');	// New in 0.0.2
$L['cfg_pfsnomimepass'] = array('Игнорировать MIME-типы', 'Разрешить закачку файлов, MIME-тип которых не указан в конфигурации.'); // New in 0.0.2
$L['cfg_pfstimename'] = array('Имена файлов на основе шаблона времени', 'Генерировать имена файлов по шаблону времени. По умолчанию используется маска ИМЯФАЙЛА_UDERID.');	// New in 0.0.2
...
$L['cfg_maxpmperpage'] = array('Макс. количество сообщений на странице', ' '); // New in 0.0.6
...
$L['cfg_max_options_polls'] = array('Максимальное количество вариантов ответа', 'Лишние варианты будут автоматически удаляться при привышении лимита');	// New in 0.0.2
...
$L['cfg_disable_rss'] = array('Отключить RSS каналы', ''); // New in 0.7.0
$L['cfg_rss_timetolive'] = array('Как часто обновлять RSS кеш', 'В секундах'); // New in 0.7.0
$L['cfg_rss_maxitems'] = array('Макс. количество элементов в RSS канале', ' '); // New in 0.7.0
$L['cfg_rss_charset'] = array('Кодировка RSS каналов', 'Набор символов (кодовая страница)'); // New in 0.7.0
$L['cfg_rss_pagemaxsymbols'] = array('Макс. количество символов для страниц', 'По умолчанию отключено'); // New in 0.7.0
$L['cfg_rss_postmaxsymbols'] = array('Макс. количество символов для сообщений форума', 'По умолчанию отключено'); // New in 0.7.0
...
$L['adm_opt_setoption_warn'] = 'Найти настройки для этого плагина. Вы хотите установить с сохранением этих настроек?'; // New in 0.0.2
$L['adm_opt_uninstall_warn'] = 'Удалить плагин с сохранением существующих настроек и прав доступа';	// New in 0.0.2
$L['adm_opt_setup_missing'] = 'Ошибка: отсутствует файл настроек!';	// New in 0.0.6

$L['adm_pluginstall_msg01'] = 'Настройка плагина...';	// New in 0.0.6
$L['adm_pluginstall_msg02'] = 'Удаление настроек плагина...';	// New in 0.0.6
$L['adm_pluginstall_msg03'] = 'Поиск файла конфигурации...';	// New in 0.0.6
$L['adm_pluginstall_msg04'] = 'Поиск частей...';	// New in 0.0.6
$L['adm_pluginstall_msg05'] = 'Установка частей...';	// New in 0.0.6
$L['adm_pluginstall_msg06'] = 'Поиск настроек в файле конфигурации...';	// New in 0.0.6
$L['adm_pluginstall_msg07'] = 'Не найдено! Установка прервана!';	// New in 0.0.6
$L['adm_pluginstall_msg08'] = 'Удаление прав пользователей для плагина...';	// New in 0.0.6
$L['adm_pluginstall_msg09'] = 'Добавление прав для групп ользователей...';	// New in 0.0.6
$L['adm_pluginstall_msg10'] = 'Сброс прав для всех пользователей...';	// New in 0.0.6
$L['adm_pluginstall_msg11'] = 'Выполнение деинсталлятора...';	// New in 0.0.6
