...
$L['cfg_cache_forums'] = array('Страничный кеш в форумах', 'Кеширует страницы целиком для гостей');
$L['cfg_cache_index'] = array('Страничный кеш на главной', 'Главная страница будет статичной для всех гостей');
$L['cfg_cache_page'] = array('Страничный кеш в page и list', 'Кеширует страницы целиком для гостей');
...
$L['cfg_shared_drv'] = array('Драйвер кеша в ОЗУ', '(См. Модули - Внутренний кеш)');
