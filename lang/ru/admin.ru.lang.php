...
$L['core_email'] = 'Настройки E-mail'; // 0.7.0
...
$L['core_performance'] = 'Производительность'; // 0.7.0
$L['core_pfs'] = &$L['PFS'];
...
$L['cfg_cache_forums'] = array('Страничный кеш в форумах', 'Кеширует странички целиком для гостей'); // 0.7.0
$L['cfg_cache_index'] = array('Страничный кеш на главной', 'Главная страница будет статичной для всех гостей'); // 0.7.0
$L['cfg_cache_page'] = array('Страничный кеш в page и list', 'Кеширует странички целиком для гостей'); // 0.7.0
...
$L['cfg_hit_percision'] = array('Точность оптимизированного счётчика просмотров', '');  // 0.7.0
$L['cfg_shared_drv'] = array('Драйвер кеша в ОЗУ', '(См. Модули - Внутренний кеш)'); // 0.7.0
...
$L['cfg_flashupload'] = array('Использовать flash-загрузку файлов', 'Позволяет одновременно загружать несколько файлов.');	// New in N-1.0.0
...
$L['adm_help_structure'] = 'Страницы категории &laquo;system&raquo; не отображаются в списках страниц и являются отдельными, самостоятельными страницами'; // New in N-0.7.0
