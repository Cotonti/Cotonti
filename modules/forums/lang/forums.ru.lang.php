...
$L['cfg_maxPostLength'] = 'Макс. длина сообщения';
$L['cfg_maxPostLength_hint'] = '0 или пусто - без ограничений';
...
$L['cfg_countposts_hint'] = 'Учитывать сообщения в этой категории при подсчете количества сообщений пользователя';
...
$L['forums_editPost'] = 'Редактировать сообщение';
...
$L['forums_messageTooLong'] = 'Сообщение слишком длинное';
