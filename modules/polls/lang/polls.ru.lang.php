...
$L['polls_id_stat_formed'] = 'формируется на сайте '.Cot::$sys['domain'].' динамически с учетом ответов посетителей.';
$L['polls_meta_desc'] = 'Все онлайн опросы веб сайта '.Cot::$sys['domain'].' списком. С учетом ответов посетителей формируется и выводится общая статистика в процентном соотношении.';
