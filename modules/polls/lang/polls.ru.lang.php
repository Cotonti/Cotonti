...
$L['cfg_pollsmaxpolls'] = array('Количество отображаемых опросов на главной');
$L['cfg_pollsmode'] = array('Режим отображения опросов на главной', '&laquo;Последние&raquo; &mdash; отображение последнего опроса (опросов)<br />&laquo;Случайные&raquo; &mdash; отображение случайного опроса (опросов)');
$L['cfg_pollsmode_params'] = array('Последние', 'Случайные');
