...
$L['install_body_message1'] = 'Этот скрипт поможет вам осуществить первичную установку и настройку Cotonti. <strong>Вы должны создать пустую базу данных</strong> на вашем сервере, так как скрипт не сможет этого сделать самостоятельно.';
