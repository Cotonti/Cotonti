...
INSERT INTO `sed_pages` (`page_state`, `page_type`, `page_cat`, `page_key`, `page_title`, `page_desc`, `page_text`, `page_author`, `page_ownerid`, `page_date`, `page_begin`, `page_expire`, `page_file`, `page_url`, `page_size`, `page_count`, `page_rating`, `page_filecount`, `page_alias`, `page_html`) VALUES
...
INSERT INTO `sed_structure` (`structure_code`, `structure_path`, `structure_tpl`, `structure_title`,
