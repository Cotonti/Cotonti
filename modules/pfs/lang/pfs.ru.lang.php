...
$L['cfg_pfstimename'] = array('Имена файлов на основе шаблона времени', 'Генерировать имена файлов по шаблону времени. По умолчанию используется маска ИМЯФАЙЛА_USERID.');
