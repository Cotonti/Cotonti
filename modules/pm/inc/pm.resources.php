...
$R['pm_icon'] = '<img class="icon" src="' . Cot::$cfg['icons_dir'] . '/' .Cot::$cfg['defaulticons'].'/modules/pm/pm.png"  alt="'.Cot::$L['pm_sendnew'].'" />';
$R['pm_icon_new'] = '<img class="icon" src="' . Cot::$cfg['icons_dir'] . '/' .Cot::$cfg['defaulticons'].'/modules/pm/pm-new.png" alt="'.Cot::$L['pm_unread'].'" />';
$R['pm_icon_trashcan'] = '<img class="icon" src="' . Cot::$cfg['icons_dir'] . '/' .Cot::$cfg['defaulticons'].'/modules/pm/pm-delete.png" alt="'.Cot::$L['Delete'].'" />';
