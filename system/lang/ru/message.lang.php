...
$L['msg104_title'] = 'Пользователь авторизован';
$L['msg104_body'] = 'Пользователь авторизован как '.$usr['name'].'';
...
$L['msg113_title'] = 'Учетная запись изменена';
$L['msg113_body'] = 'Выполнено, изменения в учетной записи сохранены';
...
$L['msg118_body'] = 'Первый этап регистрации завершен.<br />Ваша учетная запись еще не активирована.<br />После того, как администратор сайта активирует ее, вам будет направлено соответствующее письмо.';
...
$L['msg502_body'] = 'Ваше личное сообщение успешно отправлено.<br />Используйте ';
$L['msg502_body2'] = 'эту ссылку';
