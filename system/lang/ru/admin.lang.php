...
$L['adm_help_versions'] = 'Установите нужный часовой пояс сервера <a href=\'admin.php?m=config&amp;n=edit&amp;o=core&amp;p=time\'>здесь</a>, чтобы время №3 отражалось правильно.<br />Время №4 зависит от установленного в вашем профиле часового пояса.<br />Значения времени #1 и #2 игнорируются Cotonti.';
