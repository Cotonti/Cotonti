...
$L['cfg_pfstimename'] = array('Имена файлов на базе времени', 'Генерировать имена файлов из текущих временных штампов. По умолчанию используется оригинальное имя файла после необходимых преобразований.');
...
$L['adm_help_polls'] = 'Для создания опроса заполните форму и нажмите кнопку создать. Пустые ответы учитываться не будут и будут автоматически удалены. После создания голосования не рекомендуется редактировать голосование - так это может изменить ход голосования'; //N-0.0.2
$L['adm_polls_on_page'] = 'на странице'; // N-0.0.2
$L['adm_polls_error_title'] = 'Название опроса слишком короткое или отсутствует'; // N-0.0.2
$L['adm_polls_error_count'] = 'В опросе должно быть два и более вариантов ответа'; // N-0.0.2
$L['adm_polls_created'] = 'Опрос успешно создан'; // N-0.0.2
$L['adm_polls_updated'] = 'Опрос успешно обновлен'; // N-0.0.2
