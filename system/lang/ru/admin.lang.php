...
$L['cfg_maxtopicsperpage'] = array('Максимальное количество тем и сообщений на странице', ' ');
...
$L['cfg_adminemail'] = array('Email администратора сайта', 'Обязательно!');
...
$L['cfg_disable_pfs'] = array('Отключить &laquo;Мои файлы&raquo;', ' ');
$L['cfg_pfsfilecheck'] = array('Проверка файлов', 'Проверять файлы, загружаемые в &laquo;Моих файлах&raquo; и профиле, на их соответствие их формата используемому расширению. Рекомендуется включить в целях безопасности.');	// New in N-0.0.2
...
$L['cfg_th_colortext'] = array('Цвет текства миниатюры', 'По умолчанию: #FFFFFF');
...
$L['cfg_pm_allownotifications'] = array('Email уведомления', 'Отсылать на пользовательский email уведомления о поступивших личных сообщениях');
...
$L['cfg_title_forum_editpost'] = array('Форумы - правка', 'Доступные строки: {FORUM}, {SECTION}, {EDIT}');
$L['cfg_title_forum_main'] = array('Форумы - главная страница', 'Доступные строки: {FORUM}');
$L['cfg_title_forum_newtopic'] = array('Форумы - новая тема', 'Доступные строки: {FORUM}, {SECTION}, {NEWTOPIC}');
$L['cfg_title_forum_posts'] = array('Форумы - сообщения', 'Доступные строки: {FORUM}, {TITLE}');
$L['cfg_title_forum_topics'] = array('Форумы - темы', 'Доступные строки: {FORUM}, {SECTION}');
$L['cfg_title_header'] = array('Основной заголовок', 'Доступные строки: {MAINTITLE}, {DESCRIPTION}, {SUBTITLE}');
$L['cfg_title_header_index'] = array('Главная страница', 'Доступные строки: {MAINTITLE}, {DESCRIPTION}, {SUBTITLE}');
$L['cfg_title_list'] = array('Разделы', 'Доступные строки: {TITLE}');
$L['cfg_title_page'] = array('Страницы', 'Доступные строки: {TITLE}, {CATEGORY}');
$L['cfg_title_pfs'] = array('ПФП', 'Опции: {PFS}');
$L['cfg_title_pm_main'] = array('Личные сообщения', 'Доступные строки: {PM}, {INBOX}, {ARCHIVES}, {SENTBOX}');
$L['cfg_title_pm_send'] = array('Отправка личных сообщений', 'Доступные строки: {PM}, {SEND_NEW}');
$L['cfg_title_users_details'] = array('Пользователи - просмотр профиля', 'Доступные строки: {USER}, {NAME}');
$L['cfg_title_users_edit'] = array('Пользователи - редактирование пользователя', 'Доступные строки: {EDIT}, {NAME}');
$L['cfg_title_users_main'] = array('Пользователи - главная', 'Доступные строки: {USERS}');
$L['cfg_title_users_profile'] = array('Пользователи - редактирование профиля', 'Доступные строки: {PROFILE}, {NAME}');
...
$L['cfg_regnoactivation'] = array('Отменить проверку email при регистрации', 'По причине безопасности рекомендуется &laquo;Нет&raquo;!');
...
$L['cfg_useremailchange'] = array('Разрешить пользователям изменять свой email', 'По причине безопасности рекомендуется &laquo;Нет&raquo;!');
...
$L['adm_maxsizesingle'] = 'Максимальный размер одного файла в &laquo;Моих файлах&raquo; (Кб)';
$L['adm_maxsizeallpfs'] = 'Максимальный размер всех файлов в &laquo;Моих файлах&raquo; (Кб)';
...
$L['adm_opt_unpauseall'] = 'Продолжить';
...
- восстанавливая сообщение в удаленной теме, вы восстановление саму темы (если это возможно) и все дочерние сообщения';
...
$L['adm_help_allpfs'] = 'Разделы &laquo;Мои файлы&raquo; всех зарегистрированных пользователей';
$L['adm_nogd'] = 'Графическая библиотека GD не поддерживается данным хостом. Создание миниатюр для изображений в ПФП невозможно. Значение &laquo;Миниатюры&raquo; в закладке &laquo;Мои Файлы&raquo; панели конфигурации должно быть в положении &laquo;Отключено&raquo;.';
...
$L['adm_emailmask'] = 'Email-маска';
$L['adm_neverexpire'] = 'Без срока действия';
$L['adm_help_banlist'] = 'Образцы масок по IP: 194.31.13.41 , 194.31.13.* , 194.31.*.* , 194.*.*.*<br />Образцы масок по email: @hotmail.com, @yahoo (шаблоны (wildcards) не поддерживаются)<br />Запись может содержать одну IP-маску, одну email-маску или обе маски.<br />IP-адреса фильтруются для всех без исключения страниц, email-маски применяются только при регистрации пользователей.';
