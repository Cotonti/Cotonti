...
$L['cfg_av_resize'] = array('Масштабировать аватар ?', 'Автоматическое изменение разрешения аватара'); // N-0.1.0
$L['cfg_ph_resize'] = array('Масштабировать фото ?', 'Автоматическое изменение разрешения фотографии'); // N-0.1.0
$L['cfg_sig_resize'] = array('Масштабировать подпись ?', 'Автоматическое изменение разрешения изображения подписи'); // N-0.1.0
