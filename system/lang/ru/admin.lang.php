...
$L['adm_queue_unvalidated'] = 'Снято с публикации';// 0.0.3
$L['adm_queue_validated'] = 'Утверждено';// 0.0.3
...
$L['cfg_parser_disable'] = array('Отключить стандартный парсер', ''); // 0.0.3
$L['cfg_parsebbcodecom'] = array('Парсить BB-коды в комментариях и личных сообщениях', '');
...
$L['cfg_mergeforumposts'] = array('Объединять с предыдущим', 'Соединит сообщения пользователя в форуме, если они идут друг за другом. Анти-бамп должен быть выключен'); // N-0.1.0
...
$L['adm_polls_msg916_deleted'] = "Успешно удалено!";// 0.0.3
$L['adm_polls_msg916_reset'] = "Успешно сброшено!";// 0.0.3
$L['adm_polls_msg916_bump'] = "Успешно перемещено наверх!";// 0.0.3
...
$L['adm_trashcan_prune'] = 'Очищено';// 0.1.0
$L['adm_trashcan_deleted'] = 'Запись удалена';// 0.1.0
$L['adm_trashcan_restored'] = 'Запись востановлена';// 0.1.0
