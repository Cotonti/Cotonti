...
$L['cfg_mergeforumposts'] = array('Объединение сообщений', 'Объединяет сообщения пользователей, если они идут последовательно друг за другом. Анти-бамп должен быть выключен');
