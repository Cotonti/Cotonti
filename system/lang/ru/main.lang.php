...
$L['Clickhere'] = 'Продолжить...';	// New in N-0.6.0
$L['Close'] = 'Закрыть';
$L['Code'] = 'Код';
...
$L['Done'] = 'Выполнено';	// New in N-0.6.0
$L['Download'] = 'Загрузка';
...
$L['Enabled'] = 'Включено';
$L['Entry'] = 'Запись';	// New in N-0.6.0
$L['Entries'] = 'Записи';	// New in N-0.6.0
$L['Error'] = 'Ошибка';
$L['Event'] = 'Событие';
$L['Events'] = 'События';
$L['Expand'] = 'Развернуть';
...
$L['Folders'] = 'Каталоги';
$L['Forums'] = 'Форумы';
$L['Found'] = 'Найдено';	// New in N-0.6.0
$L['Galleries'] = 'Галереи';
$L['Gallery'] = 'Галерея';
$L['Gender'] = 'Пол';
