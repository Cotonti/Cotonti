...
$pageedit_array = array(
	...
	"PAGEEDIT_FORM_TEXT" => "<textarea class=\"editor\" name=\"rpagetext\" rows=\"24\" cols=\"56\">".sed_cc($pag['page_text'])."</textarea><br />".$bbcodes." ".$smilies." ".$pfs,
	"PAGEEDIT_FORM_TEXTBOXER" => "<textarea class=\"editor\" name=\"rpagetext\" rows=\"24\" cols=\"56\">".sed_cc($pag['page_text'])."</textarea><br />".$bbcodes." ".$smilies." ".$pfs,
