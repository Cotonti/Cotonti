...
$pageedit_array = array(
	...
	"PAGEEDIT_FORM_KEY" => "<input type=\"text\" class=\"text\" name=\"rpagekey\" value=\"".htmlspecialchars($pag['page_key'])."\" size=\"28\" maxlength=\"16\" />",
	"PAGEEDIT_FORM_ALIAS" => "<input type=\"text\" class=\"text\" name=\"rpagealias\" value=\"".htmlspecialchars($pag['page_alias'])."\" size=\"56\" maxlength=\"255\" />",
	...
	"PAGEEDIT_FORM_AUTHOR" => "<input type=\"text\" class=\"text\" name=\"rpageauthor\" value=\"".htmlspecialchars($pag['page_author'])."\" size=\"28\" maxlength=\"24\" />",
	"PAGEEDIT_FORM_OWNERID" => "<input type=\"text\" class=\"text\" name=\"rpageownerid\" value=\"".htmlspecialchars($pag['page_ownerid'])."\" size=\"28\" maxlength=\"24\" />",
