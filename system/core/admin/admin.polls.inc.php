...
while($row = sed_sql_fetcharray($sql))
{
	...
	$t -> assign(array(
		...
		"ADMIN_POLLS_ROW_POLL_URL_RES" => sed_url('admin', "m=polls".$poll_filter."&a=reset&id=".$id."&".sed_xg()),
...
$pollfilter="<form id=\"jump\"><select name=\"jumpbox\" size=\"1\" onchange=\"redirect(this)\">";
...
$pollfilter.="<option value=\"".sed_url('admin', "m=polls".$val[1])." \" $checked>".$val[0]."</option>";
}
$pollfilter.="</select></form>";
