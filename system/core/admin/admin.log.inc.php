...
$pagination = sed_pagination("admin.php?m=log&amp;n=".$n, $d, $totallines, 200);
list($pagination_prev, $pagination_next) = sed_pagination_pn("admin.php?m=log&amp;n=".$n, $d, $totallines, 200, TRUE);
