...
while ($row = sed_sql_fetcharray($sql))
{
	...
	$t-> assign(array(
		...
		"FORUMS_POSTS_ROW_IDURL" => "<a id=\"post_".$row['fp_id']."\" href=\"".sed_url('forums', "m=posts&id=".$row['fp_id'])."\">".$row['fp_id']."</a>",
		"FORUMS_POSTS_ROW_URL" => "<a id=\"post_".$row['fp_id']."\" href=\"".sed_url('forums', "m=posts&p=".$row['fp_id']."#".$row['fp_id'])."\">".$row['fp_id']."</a>",
