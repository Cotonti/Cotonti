...
foreach ($sql->fetchAll() as $row)
{
	...
	$t->assign(array(
		...
		'ADMIN_STRUCTURE_PATH' => cot_inputbox('text', 'rstructurepath['.$structure_id.']', $row['structure_path'], 'size="4" maxlength="255"'),
		...
		'ADMIN_STRUCTURE_TITLE' => cot_inputbox('text', 'rstructuretitle['.$structure_id.']', $row['structure_title'], 'size="25" maxlength="255"'),
