...
$R['admin_icon_ratings'] = '<img class="icon" src="system/admin/img/ratings.png" alt="" />';
...
$R['admin_icon_skins'] = '<img class="icon" src="system/admin/img/skins.png" alt="" />';
...
$R['admin_icon_tools'] = '<img class="icon" src="system/admin/img/tools.png" alt="" />';
...
$R['admin_menu_icon_other'] = '<img src="system/admin/tpl/img/adminmenu/folder.png" alt="'.$L['Other'].'" />
	<span>'.$L['Other'].'</span>';
