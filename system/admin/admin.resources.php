...
$R['admin_icon_config'] = 
	'<img class="icon" src="images/icons/default/prefs.png" alt="" />';

$R['admin_icon_ct'] = '<img class="icon" src="system/admin/img/{$code}.png" alt="" />';

$R['admin_icon_delete'] = 
	'<img class="icon" src="images/icons/default/trash.png" alt="" />';

$R['admin_icon_deny'] = '<img class="icon" src="system/admin/img/deny.png" alt="" />';
$R['admin_icon_deny_locked'] = '<img class="icon" src="system/admin/img/deny_locked.png" alt="" />';
...
$R['admin_icon_diskcache'] = '<img class="icon" src="system/admin/img/folder.png" alt="" />';
$R['admin_icon_events'] = '<img class="icon" src="system/admin/img/events.png" alt="" />';
...
$R['admin_icon_home'] = '<img class="icon" src="system/admin/img/admin.png" alt="" />';
$R['admin_icon_index'] = '<img class="icon" src="system/admin/img/index.png" alt="" />';
$R['admin_icon_info'] = '<img class="icon" src="system/admin/img/info.png" alt="" />';
$R['admin_icon_ipsearch'] = '<img class="icon" src="system/admin/img/ipsearch.png" alt="" />';
...
$R['admin_icon_lock'] = '<img class="icon" src="system/admin/img/lock.png" alt="" />';
$R['admin_icon_log'] = '<img class="icon" src="system/admin/img/page.png" alt="" />';
$R['admin_icon_main'] = '<img class="icon" src="system/admin/img/main.png" alt="" />';
$R['admin_icon_manual'] = '<img class="icon" src="system/admin/img/manual.png" alt="" />';
...
$R['admin_icon_reset'] = 
	'<img class="icon" src="images/icons/default/reset.png" alt="" />';
$R['admin_icon_rights'] = 
	'<img class="icon" src="images/icons/default/rights.png" alt="" />';
...
// Admin Menu
$R['admin_menu_icon_config'] = '<img src="system/admin/tpl/default/img/adminmenu/config.png" alt="'.$L['Configuration'].'" />
	<span>'.$L['Configuration'].'</span>';
$R['admin_menu_icon_extensions'] = '<img src="system/admin/tpl/default/img/adminmenu/extensions.png" alt="'.$L['Extensions'].'" />
	<span>'.$L['Extensions'].'</span>';
$R['admin_menu_icon_home'] = '<img src="system/admin/tpl/default/img/adminmenu/home.png" alt="'.$L['Home'].'" />
	<span>'.$L['Home'].'</span>';
$R['admin_menu_icon_module'] = '<img src="{$src}" alt="{$title}" /><span>{$title}</span>';
$R['admin_menu_icon_other'] = '<img src="system/admin/tpl/default/img/adminmenu/other.png" alt="'.$L['Other'].'" />
	<span>'.$L['Other'].'</span>';
$R['admin_menu_icon_tools'] = '<img src="system/admin/tpl/default/img/adminmenu/tools.png" alt="'.$L['Tools'].'" />
	<span>'.$L['Tools'].'</span>';
$R['admin_menu_icon_users'] = '<img src="system/admin/tpl/default/img/adminmenu/users.png" alt="'.$L['Users'].'" />
	<span>'.$L['Users'].'</span>';
