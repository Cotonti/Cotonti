...
// Admin Menu
$R['admin_menu_icon_config'] = '<img src="themes/admin/genoa/img/adminmenu/config.png" alt="'.$L['Configuration'].'" />
	<span>'.$L['Configuration'].'</span>';
$R['admin_menu_icon_extensions'] = '<img src="themes/admin/genoa/img/adminmenu/extensions.png" alt="'.$L['Extensions'].'" />
	<span>'.$L['Extensions'].'</span>';
$R['admin_menu_icon_home'] = '<img src="themes/admin/genoa/img/adminmenu/home.png" alt="'.$L['Home'].'" />
	<span>'.$L['Home'].'</span>';
$R['admin_menu_icon_module'] = '<img src="{$src}" alt="{$title}" /><span>{$title}</span>';
$R['admin_menu_icon_other'] = '<img src="themes/admin/genoa/img/adminmenu/other.png" alt="'.$L['Other'].'" />
	<span>'.$L['Other'].'</span>';
$R['admin_menu_icon_tools'] = '<img src="themes/admin/genoa/img/adminmenu/tools.png" alt="'.$L['Tools'].'" />
	<span>'.$L['Tools'].'</span>';
$R['admin_menu_icon_users'] = '<img src="themes/admin/genoa/img/adminmenu/users.png" alt="'.$L['Users'].'" />
	<span>'.$L['Users'].'</span>';
