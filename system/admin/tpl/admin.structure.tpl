<!-- BEGIN: MAIN -->
		...
		<div class="block">
			...
			<p class="paging">{ADMIN_STRUCTURE_PAGINATION_PREV}{ADMIN_STRUCTURE_PAGNAV}{ADMIN_STRUCTURE_PAGINATION_NEXT} <span>{PHP.L.Total}: {ADMIN_STRUCTURE_TOTALITEMS}, ???: {ADMIN_STRUCTURE_COUNTER_ROW}</span></p>
		</div>
		<!-- END: DEFAULT -->
