...
else
{
	...
	foreach ($res->fetchAll() as $row)
	{
		...
		$t->assign(array(
			...
			'ADMIN_EXTRAFIELDS_ROW_PARSE' => cot_selectbox($row['field_parse'], 'field_parse['.$row['field_name'].']', $parse_type, array($L['Default'], $L['None']), false, 'class="exfldparse"'),
	...
	$t->assign(array(
		...
		'ADMIN_EXTRAFIELDS_PARSE' => cot_selectbox('HTML', 'field_parse', $parse_type, array($L['Default'], $L['None']), false, 'class="exfldparse"'),
