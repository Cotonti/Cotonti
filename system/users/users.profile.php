...
$useredit_array = array(
	...
	"USERS_PROFILE_BIRTHDATE" => cot_selectbox_date(cot_date2stamp($urr['user_birthdate']), 'short', '', date('Y', $sys['now_offset']), 1910),
...
{
	$t->assign('USERS_PROFILE_'.strtoupper($row['field_name']), cot_build_extrafields('user',  $row, $urr['user_'.$row['field_name']]));
