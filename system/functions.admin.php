...
function sed_loadconfigmap()
{
	...
	$result[] = array ('performance', '06', 'gzip', 3, '1', '');
	$result[] = array ('performance', '12', 'disablehitstats', 3, '0', '');
    $result[] = array ('performance', '13', 'disableactivitystats', 3, '0', '');
	$result[] = array ('performance', '20', 'hit_precision', 2, '100', array(10,100,1000));
