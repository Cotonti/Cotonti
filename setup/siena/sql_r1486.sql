...
ALTER TABLE `cot_forum_stats` CHANGE COLUMN `fs_code` `ft_cat` varchar(255) collate utf8_unicode_ci NOT NULL default '';

ALTER TABLE `cot_forum_stats` DROP `fs_topiccount_pruned`;
ALTER TABLE `cot_forum_stats` DROP `fs_postcount_pruned`;

ALTER TABLE `cot_forum_post` ADD KEY (`fp_cat`);
