...
(96, 1, 'plug', 'passrecover', 1, 254, 1),
(97, 2, 'plug', 'passrecover', 1, 254, 1),
(98, 3, 'plug', 'passrecover', 0, 255, 1),
(99, 4, 'plug', 'passrecover', 1, 254, 1),
(100, 5, 'plug', 'passrecover', 255, 255, 1),
...
(135, 6, 'plug', 'passrecover', 1, 254, 1),
...
(33, 'more', 'str', '[more]', '<!--more-->', 1, 1, 128, '', 0),
(34, 'more', 'str', '[/more]', '&nbsp;', 1, 1, 128, '', 0),
...
('plug', 'search', '1', 'searchurl', 2, 'Normal', 'Normal,Single', 'Type of forum post link to use, Single uses a Single post view, while Normal uses the traditional thread/jump-to link'),
...
('plug', 'markitup', '01', 'autorefresh', 3, '0', '', 'Enable preview auto-refresh'),
('plug', 'markitup', '10', 'chili', 3, '0', '', 'Enable Chili tags'),
...
('core', 'title', '17', 'title_header', 1, '{MAINTITLE} - {SUBTITLE}', '', ''),
('core', 'title', '18', 'title_header_index', 1, '{MAINTITLE} - {DESCRIPTION}', '', ''),
('plug', 'indexpolls', '2', 'mode', 2, 'Recent polls', '', ''),
('plug', 'indexpolls', '1', 'maxpolls', 2, '1', '', ''),
...
CREATE TABLE `sed_forum_posts` (
  ...
  `fp_updater` varchar(100) collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `sed_forum_topics` (
  ...
  `ft_title` varchar(64) collate utf8_unicode_ci NOT NULL default '',
  `ft_desc` varchar(64) collate utf8_unicode_ci NOT NULL default '',
...
CREATE TABLE `sed_pages` (
  ...
  `page_html` text collate utf8_unicode_ci NOT NULL,
  PRIMARY KEY  (`page_id`),
...
(5, 'standalone', 'passrecover', 'main', 'Password recovery', 'passrecover', 10, 1),
