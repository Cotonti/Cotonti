...
(1, 0, 0, 'news', '', '', '', '', '', '', 'Welcome !', '...', 'Congratulations, your website is up and running !\r\n\r\nNow create your account, go [url=users.php?m=auth]there[/url], then log-in with the link at the top.\r\n\r\nNote that the first user to register is automatically activated and assigned to the group "Administrators". Then, by default, all the next visitors will have to validate their account by clicking a link in an email sent by Seditio.\r\n\r\nNext step is to go in the [url=admin.php]Administration panel[/url], tab [url=admin.php?m=config]Configuration[/url], and there tweak the settings for the system.\r\n\r\n[c1:10][url=http://www.neocrome.net/][img]skins/base/img/neocrome.gif[/img][/url][c2:90]You''ll find more instructions and tutorials in the [url=http://www.neocrome.net/list.php?c=sd]Documentation page for Sedito at Neocrome.net[/url], and technical support in our [url=http://www.neocrome.net/forums.php]discussion forums[/url].[c3]', '', 1, UNIX_TIMESTAMP()-23200, UNIX_TIMESTAMP()-23200, 1262343600, 0, '', '', 27, 0.00, 0, 0, '');
