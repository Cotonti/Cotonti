...
$L['cfg_searchurl'] = array('Вид ссылки на сообщение в форуме','"Normal" (обычная) &mdash; традиционное отображение темы с переходом к сообщению<br />"Single" (одиночная) &mdash; только одно сообщение');
