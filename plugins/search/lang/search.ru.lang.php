...
$L['plu_com_set_area'] = 'Локации сайта';
$L['plu_com_res_sort1'] = 'Дате публикации';
$L['plu_com_res_sort2'] = 'Локации';
$L['plu_com_res_sort3'] = 'Автору';
...
$L['cfg_maxsigns'] = 'Максимум символов в поиске';
$L['cfg_maxitems'] = 'Максимум результатов в обычном поиске';
$L['cfg_minsigns'] = 'Минимум символов в запросе';
$L['cfg_pagesearch'] = 'Влючить поиск по страницам';
$L['cfg_forumsearch'] = 'Включить поиск по форумам';
$L['cfg_commentssearch'] = 'Включить поиск по комментариям';
$L['cfg_searchurl'] = 'Вид отображения сообщений в форумах';
$L['cfg_searchurl_hint'] = 'Single &ndash; отдельное сообщение на странице<br />Normal &ndash; переход к сообщению при отображении всей темы';
$L['cfg_addfields'] = 'Дополнительные поля страниц для поиска, разделенные запятыми';
$L['cfg_addfields_hint'] = 'Например page_extra1, page_extra2, page_key';
$L['cfg_extrafilters'] = 'Отображать дополнительные фильтры на главной странице поиска';
