...
$t->assign(array(
	...
	'PLUGIN_SEARCH_DATE_FROM' => cot_selectbox_date($rsearch['set']['from'], 'short', 'rfrom', cot_date('Y', $sys['now_offset'])+1),
	'PLUGIN_SEARCH_DATE_TO' => cot_selectbox_date($rsearch['set']['to'], 'short', 'rto', cot_date('Y', $sys['now_offset'])+1),
