...
$L['cfg_preset_params'] = array('Удобный', 'Совместимый с Genoa/Seditio', 'Собственный urltrans.dat', 'Отключено');

$L['info_desc'] = 'С помощью этого плагина вы можете задавать расширенные правила преобразования URL в панели Администрирования, либо выбрать простую в использовании предустановку для дружественных человеку и поисковым движкам ссылок';
