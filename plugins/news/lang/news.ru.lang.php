...
'Вывод дополнительных категорий  новостей осуществляется при помощи тэга {INDEX_NEWS.КОДКАТЕГОРИИ} в файле index.tpl. При помощи шаблона news.кодкатегории.tpl можно настроить отображение новостной ленты для каждой из категорий.');
